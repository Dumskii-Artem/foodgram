    ...
    <Container>
      ...
      <div className={styles.content}>
        ...
        <aside>
          ...
          <div className={styles.text}>
            <p className={styles.textItem}>
              Код проекта находится тут - <a href="https://github.com/Dumskii-Artem/foodgram.git" className={styles.textLink}>Github</a>
            </p>
            <p className={styles.textItem}>
              Автор проекта: <a href="https://github.com/Dumskii-Artem" className={styles.textLink}>Думский Артём</a>
            </p>
            <p className={styles.textItem}>
              Телеграм канал с видео: <a href="t.me/poshli_v_IT" className={styles.textLink}>Тут</a>
            </p>
          </div>
        </aside>
      </div>
